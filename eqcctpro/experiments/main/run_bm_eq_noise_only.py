...
input_mseed_directory_path = os.path.join(base_dir, "data/waveforms_earthquakes_noise_only")
output_root_directory_path = os.path.join(base_dir, "results/csv/bm_eq_noise_only")
